...
export const NotifoPreview = (props: PushPreviewProps) => {
  const { buttons, iconUrl, imageUrl, linkName, message, title } = props;
    ...
    <div className="notifo-modal-panel">
      <div className="notifo-notification">
        ...
        <div className="notifo-notification-row2">
          ...
          <Image
            className="notifo-notification-image-small notifo-notification-left"
            src={iconUrl}
          />

          <div className="notifo-notification-right">
            <div className="notifo-notification-subject">{title}</div>

            {message && (
              <div className="notifo-notification-body">{message}</div>
            )}

            {linkName && (
              <div className="notifo-notification-link">
                <span className="notifo-link">{linkName}</span>
              </div>
            )}

            <div className="notifo-notification-time">A few minutes ago</div>
